...
TEST_CASE("Half-carry Subtract 8bit", "[cpu_utils]") {
	...
	auto result = cpu.half_carry_sub_8bit(0x00, 0x00);
	CHECK(result == false);

	result = cpu.half_carry_sub_8bit(0x00, 0x01);
	CHECK(result == true);

	result = cpu.half_carry_sub_8bit(0xff, 0xff);
	CHECK(result == false);

	result = cpu.half_carry_sub_8bit(0xf7, 0x08);
	CHECK(result == true);
}
...
TEST_CASE("Half-carry Subtract 16bit", "[cpu_utils]") {
	...
	auto result = cpu.half_carry_sub_16bit(0x0000, 0x0000);
	CHECK(result == false);

	result = cpu.half_carry_sub_16bit(0x0000, 0x0001);
	CHECK(result == true);

	result = cpu.half_carry_sub_16bit(0xff00, 0xff00);
	CHECK(result == false);

	result = cpu.half_carry_sub_16bit(0xf7ff, 0x08ff);
	CHECK(result == true);
}
...
TEST_CASE("Carry Subtract 8bit", "[cpu_utils]") {
	...
	auto result = cpu.carry_sub_8bit(0x00, 0x00);
	CHECK(result == false);

	result = cpu.carry_sub_8bit(0x00, 0x01);
	CHECK(result == true);

	result = cpu.carry_sub_8bit(0x7f, 0x80);
	CHECK(result == true);

	result = cpu.carry_sub_8bit(0x3d, 0xa4);
	CHECK(result == true);
}
...
TEST_CASE("Carry Subtract 16bit", "[cpu_utils]") {
	...
	auto result = cpu.carry_sub_16bit(0x0000, 0x0000);
	CHECK(result == false);

	result = cpu.carry_sub_16bit(0x0000, 0x0001);
	CHECK(result == true);

	result = cpu.carry_sub_16bit(0x7f00, 0x8000);
	CHECK(result == true);

	result = cpu.carry_sub_16bit(0x3d00, 0xa400);
	CHECK(result == true);
}
